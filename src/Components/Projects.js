	...
	return(
        <div className="projects">
           <section class="">
            ...
            <div class="flex flex-wrap mx-auto md:flex-nowrap p-12 gap-6">
                <article
                class="flex-col hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s] transition-all ease-in-out delay-150"
                >
                <div class="rounded-[10px] bplv-pr-project p-4 sm:p-6 relative">
                    <a href="https://github.com/bplv112/wp-local-addon-wpcli">
                        <div className="icon absolute top-5 right-10">
                            <img src={github} />
                        </div>
                        <h3 class="mt-0.5 text-xl font-medium text-gray-900">
                            WPCLI Fixer
                        </h3>
                    </a>
